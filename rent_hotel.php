            ...
            <?php
                ...
                while($per = mysqli_fetch_array($result)){
                    ...
                    echo "<table>";
                        ...
                        echo    "<td><img class='photoContainer' src='" . $per[7] . "'style='border: none;' alt='No Image'/></td>";
                        ...
                        echo "<br>";
                        echo    "&nbsp&nbsp<b>Διεύθυνση:</b> $per[2]<br>";
                        echo    "&nbsp&nbsp<b>Τηλέφωνο:</b> $per[3]</td>";
                        echo    "<td style='line-height: 130%; width: 100%;'>";
                        echo    "<a class='show_more_button' style='margin-right: 25%; margin-top: 30%;' href='rent_hotel_more.php?hotel_name=" . $per[0] . "'  onclick='post'>Περισσότερα</a></td></tr>";
                    echo "</table>";
                    echo "</div>";*/
                }
            ?>   
